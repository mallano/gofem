...
// RjointM1 implements Drucker-Prager plasticity model
...
func init() {
	allocators["rjoint-m1"] = func() Solid { return new(RjointM1) }
}
...
func (o RjointM1) InitIntVars() (s *State, err error) {
	s = NewState(o.Nsig, 1, 0, false)
	return
}

// Update updates stresses for given strains
func (o *RjointM1) Update(s *State, ε, Δε []float64) (err error) {
...
func (o *RjointM1) CalcD(D [][]float64, s *State, firstIt bool) (err error) {
...
func (o *RjointM1) ContD(D [][]float64, s *State) (err error) {
